...
type VehicleListItem struct {
	...
	BrandID            *string     `json:"brand_id" extensions:"x-nullable"`
	BrandOther         *string     `json:"brand_other" extensions:"x-nullable"`
	BrandName          *string     `json:"brand_name" extensions:"x-nullable"`
	ModelID            *string     `json:"model_id" extensions:"x-nullable"`
	ModelOther         *string     `json:"model_other" extensions:"x-nullable"`
	ModelName          *string     `json:"model_name" extensions:"x-nullable"`
