...
// SalesforceWebhookDados mirrors the Salesforce Person Account GET shape for delta payloads.
type SalesforceWebhookDados struct {
	...
	Consentimento          []clients.SalesforceConsentimento `json:"consentimento,omitempty"`
}
